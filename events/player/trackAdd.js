...
module.exports = async(queue, track,client) => {
    ...
    const embed = new MessageEmbed()
      .setAuthor(`Track queued  `,`https://images-ext-1.discordapp.net/external/y9xo3cmx7zqBCO5_G8ihraaodI-Ga8ZNbTYeP6MdVPk/https/cdn.discordapp.com/emojis/763415718271385610.gif`)
